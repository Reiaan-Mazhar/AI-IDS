...
def cicids_preprocess(path="datasets/chethuhn/network-intrusion-dataset/versions/1", mode="train", pre1=False):
    if mode=="train":
        ...
        # data1 = pd.read_csv(f'/home/irfan/Downloads/fyp/createTestDataSet/CIC_IDS_2017_Test_Set.csv')
        data2= pd.read_csv(f'/home/irfan/Downloads/fyp/createTestDataSet/Wednesday-workingHours.pcap_ISCX.csv')
        data_list = [data2]
